...
abstract class HomeService {
  ...
  Future<void> addFavoriteItem(ProductItem product, String userId);
  Future<void> removeFavoriteItem(String productId, String userId);
  Future<List<ProductItem>> fetchFavoriteData(
    String userId,
  ); // FIXED: Returns List
}
